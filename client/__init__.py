...
import requests
from client.api.class_schedule import ScheduleClass
from client.api.score import Score
from client.api.user_info import Info
from client.utils import user_is_login
from config import URL_ENDPOINT
from client.api.schedules import Schedule
from client.exceptions import LoginException
import time
from client.api.login import ZFLogin
from client.base import BaseUserClient
...
class SchoolClient():
    ...
    def __init__(self, host, port: int = 80, ssl: bool = False, name=None, exist_verify: bool = False,
        ...
        self.base_url = f'https://{host}:{port}/jwglxt' if ssl else f'http://{host}:{port}/jwglxt'
